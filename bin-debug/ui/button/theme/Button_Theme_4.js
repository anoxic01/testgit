...
(function (ui) {
    ...
    (function (button) {
        var theme;
        (function (theme) {
            var Button_Theme_4 = (function (_super) {
                __extends(Button_Theme_4, _super);
                function Button_Theme_4() {
                    var _this;
                    var arr = [
                ...
                Button_Theme_4.prototype.onClick = function () {
                    console.log("theme_4 按钮点击了!");
                };
                return Button_Theme_4;
            }(theme.Button_Theme));
            theme.Button_Theme_4 = Button_Theme_4;
            __reflect(Button_Theme_4.prototype, "ui.button.theme.Button_Theme_4");
        })(theme = button.theme || (button.theme = {}));
    })(button = ui.button || (ui.button = {}));
})(ui || (ui = {}));
//# sourceMappingURL=Button_Theme_4.js.map
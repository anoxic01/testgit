module lobby.model.struct {
	export class TableStruct {
		...
		public CharterSettingInfo		:	CharterSettingStruct;		//包桌设置
		...
		public StaticsInfo				:	StaticsInfoStruct;				//即时彩池
		 ...
		 */
		public joinTableType			:	number		=	model.type.JoinTableType.NORMAL_PAIR_TABLE_SEAT;
		...
		public constructor( oTable:Object=null ) {
			...
			if(this.CharterSettingInfo==null){
				this.CharterSettingInfo = new struct.CharterSettingStruct();
			}
		...
		//	this.CharterSettingInfo		=	oTable["CharterSettingInfo"];
			...
			if( oTable["StaticsInfo"] != null ){
				...
				byte.writeByte(oTable["StaticsInfo"]);
				byte.position = 0;
				var obj:Object = byte.readByte();
...
//			if(TableID==45){
//				console.log("45桌更新倒计时：",CountDownTime);
//			}
		}
		...
		public update(oTable:Object=null):void{
			...
			if(oTable["GameStatus"]==model.status.GameStatus.SETTLED){
		...
		public updateStaticsInfo(_staticsInfo):void{
		...
		public setTable(_table:view.table.Table):void{
			this.m_table = _table;
//			console.log("table_struct_tableid",TableID, "_table_name",_table.name);
		}

...
//		private var m_bmpTable		:	Bitmap;							//桌子序号
		...
		private var m_road			:	QuickTableRoadMapRou;			//路纸
...
//		private var m_btnLimit		:	ButtonMcLanguage;				//限红选择
		...
		public constructor() {
			...
			m_road = new QuickTableRoadMapRou(m_mcAsset);
...
//			}
		...
		override public function setData(_tableStruct:TableStruct):void{
			...
			switch(m_struct.TableType){
				...
				case Define.TABLE_TYPE_ROBOT:
					m_mcTableName = ResourceManager.getInstance().getInstanceByNameFromDomain(Define.SWF_TABLE,"Table_Label_Rou_Asset");
		...
		override public function onChangeLanguage():void{
			...
			m_mcAsset.tf_label.text = "";//LobbyManager.getInstance().getLanguageString(Language.sGame_Name_Rou) + String(m_struct.TableID) + LobbyManager.getInstance().getLanguageString(Language.sTable);

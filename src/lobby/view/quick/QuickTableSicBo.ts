module lobby.view.quick {
	export class QuickTableSicBo extends QuickTable{
...
//		private m_btnLimit		:	ButtonMcLanguage;				//限红选择
		...
		public constructor() {
			...
			this.m_road = new route.quick.QuickTableRoadMapSic(this.m_mcAsset);
...
//			}
		 ...
		 public setData(_tableStruct):void{
			...
			this.m_mcTableName = manager.ResourceManager.getInstance().getInstanceByNameFromDomain(define.Define.SWF_TABLE,"Table_Label_Sic_Asset");
		 ...
		 public onChangeLanguage():void{
			...
			this.m_mcAsset.tf_label.text = "";//manager.LobbyManager.getInstance().getLanguageString(language.Language.sGame_Name_Sic) + String(this.m_struct.TableID) + manager.LobbyManager.getInstance().getLanguageString(language.Language.sTable);
